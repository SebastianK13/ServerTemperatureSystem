...
namespace ServerTemperatureSystem.Migrations
{
    ...
    [Migration("20210725202655_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServerTemperatureSystem.Models.TemperatureDetails", b =>
                {
                    b.HasOne("ServerTemperatureSystem.Models.CPU", null)
                        .WithMany("TemperatureReadings")
                        .HasForeignKey("CPUId");

                    b.HasOne("ServerTemperatureSystem.Models.Core", null)
                        .WithMany("TemperatureReadings")
                        .HasForeignKey("CoreId");

                    b.HasOne("ServerTemperatureSystem.Models.Motherboard", null)
                        .WithMany("TemperatureReadings")
            ...
            modelBuilder.Entity("ServerTemperatureSystem.Models.UsageDetails", b =>
                {
                    ...
                    b.HasOne("ServerTemperatureSystem.Models.Memory", null)
                        .WithMany("UsageReadings")
